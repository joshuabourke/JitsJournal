...
/*
 ...
 3. I am wanting to make it so I can update everyones data with cloud functions. I am wanting to add the belt rank to all of the submissions that are logged into mybjj. This will allow me to start gathering even more data on bjj. I need to learn how to write cloud functions to update the data we have stored with all of the users. So then I wont need to write long functions in swift to make up for not being able to update the back end.
...
//MARK: - TO COME TO NotificationSettinsView
 /*
  This is the view that is responsiable for the reminders for the users.
  
  1. I am needing to fix a bug in there that is causing the users app the crash. I think it could be the user adding 2 of the same reminder. It could also be that that are trying to set to many days. It currently only supports the single day. So you would then have to go through and set all of your reminders manually.
