...
struct NotificationSettingsView: View {
    ...
    var body: some View {
        VStack {
            ...
            .padding(.horizontal)
            Text("Select the day of the week and time you would like to be reminded to log progress. Make sure you have notifications turned on for MyBJJ, or else this function won't work.")
                .font(.caption)
